...
function show_help() {
  ...
  Options:\n
  \t-i --image_name\t\t Name of the image to be run (default ros2_foxy).\n
  \t-c --container_name\t Name of the container(default ros2_foxy_container).\n
...
IMAGE_NAME=${IMAGE_NAME:-ros2_foxy}
CONTAINER_NAME=${CONTAINER_NAME:-ros2_foxy_container}
